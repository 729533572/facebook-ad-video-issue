...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        // Comment the line below to enable rewarded video playback
        URL.setURLStreamHandlerFactory(new DummyHandler());
    ...
    public void selectDrawerItem(MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            ...
            case R.id.nav_rewarded_video_fragment:
                ...
                break;
            case R.id.nav_exoplayer_test_fragment:
                fragmentClass = ExoPlayerTest.class;
                break;
            default:
